        ...
        $newSystemEnrollments = $program->enrollments()
            ...
            ->map(function ($enrollment) {
                return [
                    ...
                    'enrollment_date' => $enrollment->enrollment_date ? \Carbon\Carbon::parse($enrollment->enrollment_date)->format('Y-m-d') : null,
                    'date_started' => $enrollment->date_started ? \Carbon\Carbon::parse($enrollment->date_started)->format('Y-m-d') : null,
                    'completion_date' => $enrollment->completion_date ? \Carbon\Carbon::parse($enrollment->completion_date)->format('Y-m-d') : null,
                    'date_ended' => $enrollment->date_ended ? \Carbon\Carbon::parse($enrollment->date_ended)->format('Y-m-d') : null,
                    'status' => $enrollment->status,
                    'payment_status' => $enrollment->payment_status,
                    'enrollment_fee' => $enrollment->enrollment_fee,
                    'payment_method' => $enrollment->payment_method,
                    'payment_reference' => $enrollment->payment_reference,
                    'payment_date' => $enrollment->payment_date ? \Carbon\Carbon::parse($enrollment->payment_date)->format('Y-m-d') : null,
        ...
        $legacyTrainees = \App\Models\Trainee::where('program_qualification', $program->name)
            ...
            ->map(function ($trainee) {
                return [
                    ...
                    'batch' => $trainee->batch,
                    'enrollment_date' => $trainee->created_at ? \Carbon\Carbon::parse($trainee->created_at)->format('Y-m-d') : null,
                    'date_started' => $trainee->date_started ? \Carbon\Carbon::parse($trainee->date_started)->format('Y-m-d') : null,
                    'completion_date' => $trainee->completion_date ? \Carbon\Carbon::parse($trainee->completion_date)->format('Y-m-d') : null,
                    'date_ended' => $trainee->date_ended ? \Carbon\Carbon::parse($trainee->date_ended)->format('Y-m-d') : null,
